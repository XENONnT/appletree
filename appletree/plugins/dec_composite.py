...
class DECEnergy(Plugin):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.dec_mode_energy = jnp.array([dec_mode_energy[mode] for mode in self.dec_modes.value])
...
class DECRecombComposeRunningR(Plugin):
    ...
    def simulate(self, key, parameters, recomb_x, recomb_y, num_ion_x, num_ion_y):
        ...
        recomb = v_running_r_recomb(num_ion_x, num_ion_y, scale_x, scale_y)
